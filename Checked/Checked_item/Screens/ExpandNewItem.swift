//
//  ExpandNewItemView.swift
//  Checked
//
//  Created by Alessandro Di Ronza on 14/08/23.
//

import SwiftUI

struct ExpandNewItemView: View {
...
struct ExpandNewItemView_Previews: PreviewProvider {
    @State static var newItemPresent = true
    @State static var TitleAdded = false
    @State static var DateAdded = false
    
    static var previews: some View {
        ExpandNewItemView(newItemPresent: $newItemPresent, TitleAdded: $TitleAdded, DateAdded: $DateAdded)
    }
}
